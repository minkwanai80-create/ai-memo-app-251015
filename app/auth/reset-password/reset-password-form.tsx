...
export function ResetPasswordForm() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-purple-600">인증을 확인하는 중...</p>
                </div>
            </div>
        )
    }
    ...
    if (error || !hasValidSession) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
